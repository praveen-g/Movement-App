...
.controller('GeoCtrl', function($scope, $cordovaGeolocation, $cordovaBackgroundGeolocation, $ionicPlatform)
{ 
...
.controller('RegisterCtrl', function($scope, $state, $ionicPlatform){
