...
app.controller('GeoCtrl', function($scope, $cordovaGeolocation, $BackgroundGeolocation) {

  $scope.points = [];

  //function to convert time stamp to hours
  ...
  //function onDeviceReady() {
    ...
    var callbackFn = function(location, taskId) {
        ...
        */
        ...
        setTimeout(function() {
          $BackgroundGeolocation.finish(taskId); // <-- execute #finish when your work in callbackFn is complete
        }, 1000);
    };
 ...
 $BackgroundGeolocation.start(); // start background geolocation services
 // }
});
